...
<body>
    ...
    <div id="top"></div>
		...
		<div id="container">
			...
			<div id="main">
				<asp:GridView ID="policiesAndRegulationsGridView" Width="90%" runat="server" AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton2" CssClass="linkbutton_style" runat="server" CausesValidation="false" CommandName=""  Text="查看详情" OnClick="LinkButton2_Click"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                        </Columns>
